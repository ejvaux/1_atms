<p>Hello <i>{{ $mail->tech }}</i>,</p>

<p>You receive this email because the ticket 
with ticket #{{ $mail->ticketnum }} is been assigned to you 
by {{ $mail->assigner }}. Please click button below to view ticket details.</p>
