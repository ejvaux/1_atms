                            ...
                            <div class="col-md">
                                <ul class="nav justify-content-center labelfontbold">
                                    <li class="nav-item mx-1">
                                        <a href="{{url('/it/rp/ctoday')}}" class="nav-link btn btn-secondary">Day</a>
                                    </li>
                                    <li class="nav-item mx-1">
                                    ...
                                    <li class="nav-item mx-1">
                                        <a href="{{url('/it/rp/cyear')}}" class="nav-link btn btn-outline-secondary">Year</a>
                                    </li>
                                    <li class="nav-item mx-1 ">
                                        <div class="dropdown">  
                ...
                <div class="card-body text-center p-3 pb-0">
                    <div class="row">
                        <div class="col-md-5 stat3 p-2">
                            <span class='font-weight-bold statnum'>{{$reviews}}</span>
                        </div>
        ...
        <div class='col-md-4'>
            <div class="card repcard2 border-0">
                <div class="card-body text-center p-3 pb-0">
                    <div class="row">
                        <div class="col-md-5 stat3 p-2">
                            <span class='font-weight-bold statnum'>{{$approvedreviews}}</span>
                        </div>
                        <div class="col-md-7 stat3-2 p-2">
        ...
        <div class='col-md-4'>
            <div class="card repcard2 border-0">
                <div class="card-body text-center p-3 pb-0">
                    <div class="row">
                        <div class="col-md-5 stat3 p-2">
                            <span class='font-weight-bold statnum'>{{$inprogressreviews}}</span>                                            
                        </div>
                        <div class="col-md-7 stat3-2 p-2">
                ...
                <div class="card-body text-center p-3 pt-0">
                    <div class="row">
                        <div class="col-md-5 stat3 p-3">
                            <span class='font-weight-bold statnum'>{{$totalcompletedreviews}}</span>
                        </div>
                        <div class="col-md-7 stat3-2 p-2">
