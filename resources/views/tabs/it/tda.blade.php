            ...
            <nav>
                <ol class="breadcrumb">
                    @if(Auth::user()->admin == 1)
                        <li class="breadcrumb-item"><a href="{{ url('/it/al') }}">Ticket</a></li>
                    @else
                        <li class="breadcrumb-item"><a href="{{ url('/it/lt') }}">My Ticket</a></li>
                    @endif                    
                    <li class="breadcrumb-item"><a href="{{ URL::previous() }}">Ticket Details</a></li>
