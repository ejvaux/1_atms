        ...
        <div class='col-md'>
            <div class="card" style='width:100%'>
                ...
                <div class="card-body">
                                ...
                                <div class="col-md">
                                    @if (!empty($request->attach) && Auth::user()->req_approver == 1)                                
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            @endif
                                                <label class="custom-control-label font-weight-bold" for="allow_checkbox"><span style='background-color:yellow'>SHOW ATTACHMENTS TO THE REQUESTOR</span></label>
                                        </div>
                                    @endif
                                </div>    
                            </div>                                                                               
                    ...
                    <div class='row mb-2'>
                        ...
                        <div class='col-md-7'>
                            @if($request->attach != null)
                                @if ($request->allow == 1 || Auth::user()->id == $request->assigned_to || Auth::user()->admin == 1 || Auth::user()->req_approver == 1)
                    ...
                    @if ( Auth::user()->admin == 1 || Auth::user()->req_approver == 1 || Auth::user()->id == $request->assigned_to /* || $request->allow == 1 */)                    
