                    ...
                    @else
                        <div class="nav-item dropdown"> 
                            <a href="#" class="nav-link" data-toggle="dropdown">
                                @if(Auth::user()->unReadNotifications->count()>0)<span class="badge badge-danger">{{Auth::user()->unReadnotifications->count()}}</span>@else <span class="badge badge-danger"></span> @endif <i class="fa fa-bell"></i> <span class='hidewhensmall labelfontbold'> Notification</span></a>
